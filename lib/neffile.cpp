...
static const BuiltinColourMatrix s_matrices[] = {
    ...
    // Identical to D4 according to dcraw.
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_D4S), 0, 0,
      { 8598, -2848, -857, -5618, 13606, 2195, -1002, 1773, 7137 } },
    ...
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_D5200), 0, 0,
      { 8322,-3112,-1047,-6367,14342,2179,-988,1638,6394 } },
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_D60), 0, 0,
      { 8736,-2458,-935,-9075,16894,2251,-1354,1242,8263 } },
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_D600), 0, 0,
      { 8139,-2171,-663,-8747,16541,2295,-1925,2008,8093 } },
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_D610), 0, 0,
      { 8139,-2171,-663,-8747,16541,2295,-1925,2008,8093 } },
    ...
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_D7000), 0, 0,
      { 8198,-2239,-724,-4871,12389,2798,-1043,2050,7181 } },
    // From DNG Converter 7.4
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_D7100), 0, 0,
      { 8322,-3112,-1047,-6367,14342,2179,-988,1638,6394 } },
    // From DNG Converter 8.7-rc
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_D750), 0, 0,
    ...
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_DF), 0, 0,
      { 8598,-2848,-857,-5618,13606,2195,-1002,1773,7137 } },
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_E5400), 0, 0,
      { 9349,-2987,-1001,-7919,15766,2266,-2098,2680,6839 } },

//    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_E5700), 0, 0,
//      { -5368,11478,2368,5537,-113,3148,-4969,10021,5782,778,9028,211 } },
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_E8400), 0, 0,
    ...
    // From DNG Converter 7.4
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_1_J2), 0, 0,
      { 8994,-2667,-865,-4594,12324,2552,-699,1786,6260 } },
    // From DNG Converter 7.4
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_1_J3), 0, 0,
    ...
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_1_V2), 0, 0,
      { 6588,-1305,-693,-3277,10987,2634,-355,2016,5106 } },
    // From DNG Converter 7.4
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_1_S1), 0, 0,
      { 8994,-2667,-865,-4594,12324,2552,-699,1786,6260 } },
    // From DNG Converter 7.4
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_COOLPIX_A), 0, 0,
      { 8198,-2239,-724,-4871,12389,2798,-1043,2050,7181 } },

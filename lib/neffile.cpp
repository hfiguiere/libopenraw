...
const IfdFile::camera_ids_t NefFile::s_def[] = {
    ...
    { "NIKON D3", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON, 
                                      OR_TYPEID_NIKON_D3) },
    { "NIKON D3S", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON, 
                                      OR_TYPEID_NIKON_D3S) },
    { "NIKON D3X", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON, 
                                      OR_TYPEID_NIKON_D3X) },
    { "NIKON D300", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON, 
                                        OR_TYPEID_NIKON_D300) },
    { "NIKON D300S", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON, 
    ...
    { "NIKON D3200", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON, 
    ...
    { "NIKON D50", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON,
                                       OR_TYPEID_NIKON_D50) },
    { "NIKON D5000", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON,
                                       OR_TYPEID_NIKON_D5000) },
    { "NIKON D5100", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON,
    ...
    { "NIKON D700", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON,
    ...
    { "NIKON D80", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON,
                                       OR_TYPEID_NIKON_D80) },
    { "NIKON D800", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON,
    ...
    { "COOLPIX P7100", OR_MAKE_FILE_TYPEID(OR_TYPEID_VENDOR_NIKON,

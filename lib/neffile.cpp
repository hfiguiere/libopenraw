...
static const BuiltinColourMatrix s_matrices[] = {
    ...
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_J1), 0, 0,
      { 8994,-2667,-865,-4594,12324,2552,-699,1786,6260 } },
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_V1), 0, 0,
      { 8994,-2667,-865,-4594,12324,2552,-699,1786,6260 } },
    { OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_V2), 0, 0,
...
const IfdFile::camera_ids_t NefFile::s_def[] = {
    ...
    { "NIKON 1 J1", OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_J1) },
    { "NIKON 1 V1", OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_V1) },
    { "NIKON 1 V2", OR_MAKE_NIKON_TYPEID(OR_TYPEID_NIKON_V2) },
    { 0, 0 }
};

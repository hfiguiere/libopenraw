...
static const BuiltinColourMatrix s_matrices[] = {
    ...
    { OR_MAKE_SONY_TYPEID(OR_TYPEID_SONY_A3000),
      128,
      0,
      { 5991, -1456, -455, -4764, 12135, 2980, -707, 1425, 6701 } },
    ...
    { OR_MAKE_SONY_TYPEID(OR_TYPEID_SONY_A6500),
      0,
      0,
      { 5973, -1695, -419, -3826, 11797, 2293, -639, 1398, 5789 } },
    ...
    { OR_MAKE_SONY_TYPEID(OR_TYPEID_SONY_A7RM2),
      ...
      0,
      { 6629, -1900, -483, -4618, 12349, 2550, -622, 1381, 6514 } },
    { OR_MAKE_SONY_TYPEID(OR_TYPEID_SONY_A7RM3),
      0,
      0,
...
const IfdFile::camera_ids_t ArwFile::s_def[] = {
    ...
    { "ILCE-3500", OR_MAKE_SONY_TYPEID(OR_TYPEID_SONY_A3500) },
    { "ILCE-5100", OR_MAKE_SONY_TYPEID(OR_TYPEID_SONY_A5100) },

...
enum {
    ...
    OR_TYPEID_SONY_NEX5 = 10,
    OR_TYPEID_SONY_NEX5N = 11,
    OR_TYPEID_SONY_NEXC3 = 12,
    OR_TYPEID_SONY_SLTA65 = 13,
    OR_TYPEID_SONY_NEX7 = 14,
    OR_TYPEID_SONY_A330 = 15,
    OR_TYPEID_SONY_A350 = 16,
    OR_TYPEID_SONY_A450 = 17,
    OR_TYPEID_SONY_A580 = 18,
    OR_TYPEID_SONY_A850 = 19,
    OR_TYPEID_SONY_A900 = 20,
    OR_TYPEID_SONY_SLTA35 = 21,
    OR_TYPEID_SONY_SLTA33 = 22,
    OR_TYPEID_SONY_A560 = 23,
    OR_TYPEID_SONY_SLTA99 = 24,
    OR_TYPEID_SONY_RX100 = 25,
    OR_TYPEID_SONY_RX1 = 26,
    OR_TYPEID_SONY_NEX6 = 27,
    OR_TYPEID_SONY_SLTA57 = 28,
    OR_TYPEID_SONY_NEXF3 = 29,
    OR_TYPEID_SONY_NEX5R = 30,
    OR_TYPEID_SONY_RX100M2 = 31,
    OR_TYPEID_SONY_RX1R = 32,
    OR_TYPEID_SONY_A7R = 33,
    OR_TYPEID_SONY_A7 = 34,
    OR_TYPEID_SONY_A3000 = 35,
    OR_TYPEID_SONY_A3500 = OR_TYPEID_SONY_A3000,
    OR_TYPEID_SONY_NEX5T = 36,
    OR_TYPEID_SONY_SLTA58 = 37,
    OR_TYPEID_SONY_A6000 = 38,
    OR_TYPEID_SONY_RX100M3 = 39,
    OR_TYPEID_SONY_ILCA99M2 = 40,
    OR_TYPEID_SONY_A7RM2 = 41,
    OR_TYPEID_SONY_A6300 = 42,
    OR_TYPEID_SONY_A6500 = 43,
    OR_TYPEID_SONY_RX100M4 = 44,
    OR_TYPEID_SONY_RX100M5 = 45,
    OR_TYPEID_SONY_RX10 = 46,
    OR_TYPEID_SONY_RX10M2 = 47,
    OR_TYPEID_SONY_RX10M3 = 48,
    OR_TYPEID_SONY_RX1RM2 = 49,
    OR_TYPEID_SONY_RX10M4 = 50,
    OR_TYPEID_SONY_RX0 = 51,
    OR_TYPEID_SONY_A7M3 = 52,
    OR_TYPEID_SONY_A7RM3 = 53,
    OR_TYPEID_SONY_A5100 = 54,
    OR_TYPEID_SONY_A230 = 55,
    OR_TYPEID_SONY_A500 = 56,
    OR_TYPEID_SONY_SLTA37 = 57,
    OR_TYPEID_SONY_ILCA77M2 = 58,
    OR_TYPEID_SONY_ILCA68 = 59,
    OR_TYPEID_SONY_NEX3N = 60,
    OR_TYPEID_SONY_A7M2 = 61,
    OR_TYPEID_SONY_A7S = 62,
    OR_TYPEID_SONY_A7SM2 = 63,
    OR_TYPEID_SONY_A9 = 64,
    OR_TYPEID_SONY_ILCE5000 = 65,
    OR_TYPEID_SONY_RX100M6 = 66,
...
enum {
    ...
    OR_TYPEID_FUJIFILM_HS30EXR = 41,
    OR_TYPEID_FUJIFILM_XT100 = 42,

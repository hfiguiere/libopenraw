...
enum {
    ...
    OR_TYPEID_FUJIFILM_XA1 = 36,
    OR_TYPEID_FUJIFILM_XA2 = 37,
    OR_TYPEID_FUJIFILM_XA3 = 38,
    OR_TYPEID_FUJIFILM_XA5 = 39,
    OR_TYPEID_FUJIFILM_XQ1 = 40,
    OR_TYPEID_FUJIFILM_XQ2 = 41,
    OR_TYPEID_FUJIFILM_XH1 = 42,
    OR_TYPEID_FUJIFILM_GFX50S = 43,
    OR_TYPEID_FUJIFILM_XT3 = 44,
    OR_TYPEID_FUJIFILM_XF10 = 45,

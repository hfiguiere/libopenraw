...
lazy_static::lazy_static! {
    pub(super) static ref MATRICES: [BuiltinMatrix; 109] = [
    /* CRW */
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::EOS_D30),
      0,
      0,
      [ 9805, -2689, -1312, -5803, 13064, 3068, -2438, 3075, 8775 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::EOS_D60),
      0,
      0xfa0,
      [ 6188, -1341, -890, -7168, 14489, 2937, -2640, 3228, 8483 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::EOS_10D),
      0,
      0xfa0,
      [ 8197, -2000, -1118, -6714, 14335, 2592, -2536, 3178, 8266 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::EOS_300D),
      0,
      0xfa0,
      [ 8197, -2000, -1118, -6714, 14335, 2592, -2536, 3178, 8266 ] ),
//    BuiltinMatrix::new( TypeId(vendor::CANON, canon::G1),
//      0,
//      0,
//	[ -4778, 9467, 2172, 4743, -1141, 4344, -5146, 9908, 6077, -1566, 11051, 557 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::G2),
      0,
      0,
      [ 9087, -2693, -1049, -6715, 14382, 2537, -2291, 2819, 7790 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::G3),
      0,
      0,
      [ 9212, -2781, -1073, -6573, 14189, 2605, -2300, 2844, 7664 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::G5),
      0,
      0,
      [ 9757, -2872, -933, -5972, 13861, 2301, -1622, 2328, 7212 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::G6),
      0,
      0,
      [ 9877, -3775, -871, -7613, 14807, 3072, -1448, 1305, 7485 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::PRO1),
      0,
      0,
      [ 10062, -3522, -999, -7643, 15117, 2730, -765, 817, 7323 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::S30),
      0,
      0,
      [ 10566, -3652, -1129, -6552, 14662, 2006, -2197, 2581, 7670 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::S40),
      0,
      0,
      [ 8510, -2487, -940, -6869, 14231, 2900, -2318, 2829, 9013 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::S45),
      0,
      0,
      [ 8163, -2333, -955, -6682, 14174, 2751, -2077, 2597, 8041 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::S50),
      0,
      0,
      [ 8882, -2571, -863, -6348, 14234, 2288, -1516, 2172, 6569 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::S60),
      0,
      0,
      [ 8795, -2482, -797, -7804, 15403, 2573, -1422, 1996, 7082 ] ),
    BuiltinMatrix::new( TypeId(vendor::CANON, canon::S70),
      0,
      0,
